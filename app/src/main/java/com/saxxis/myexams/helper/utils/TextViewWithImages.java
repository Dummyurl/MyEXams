...
/**
 * Created by saxxis25 on 11/4/2017.
 */

public class TextViewWithImages extends android.support.v7.widget.AppCompatRadioButton {

    private static final String DRAWABLE = "drawable";
    /**
     * Regex pattern that looks for embedded images of the format: [img src=imageName/] img src=\E([a-zA-Z0-9_]+?)\Q/
     */
    public static final String PATTERN = "(.*/)*.+\\.(png|jpg|gif|bmp|jpeg|PNG|JPG|GIF|BMP)$}";
